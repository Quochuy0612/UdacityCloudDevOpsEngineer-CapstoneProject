...
- **Management** is needed to configure and manage the  and its deployments and services. I created two management hosts for extra redundancy if one of them fails.
